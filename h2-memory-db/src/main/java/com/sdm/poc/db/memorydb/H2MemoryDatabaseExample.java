package com.sdm.poc.db.memorydb;
...
public class H2MemoryDatabaseExample {
    ...
    private static Connection getDBConnection() {
        ...
        // due to JDBC 4 enhancements (http://www.onjava.com/2006/08/02/jjdbc-4-enhancements-in-java-se-6.html) the
        // the following commented code is not required.
//        try {
